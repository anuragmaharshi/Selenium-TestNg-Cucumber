...
//        beliButton.isDisplayed();
        System.out.println("Product page - def");
        return true;
    }
...
//        stokProductDetail.isDisplayed();
        System.out.println("Product page - non");
        return true;
    }

    public boolean fisikProductDetailDataIsDisplayed() {
        System.out.println("Product page - fis");
        return true;
    }
...
//        return allBreadcrumbProductDetail.get(index).getText();
        System.out.println("Product page - getall");
        return  "";
    }

    public boolean moreBreadcrumbIsDisplayed() {
        System.out.println("Product page - more");
        return true;
    }
}
